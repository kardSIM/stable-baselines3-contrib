...
from sb3_contrib.iqn.policies import CnnPolicy, MlpPolicy, MultiInputPolicy, IQNPolicy,  ImplicitQuantileNetwork
...
class IQN(OffPolicyAlgorithm):
    ...
    def _create_aliases(self) -> None:
        ...
        self.n_sample = self.policy.n_sample
        self.n_p_sample = self.policy.n_p_sample
    ...
    def train(self, gradient_steps: int, batch_size: int = 100) -> None:
        ...
        for _ in range(gradient_steps):
            ...
            with th.no_grad():
                ...
                next_quantiles = self.quantile_net_target(replay_data.next_observations, self.n_p_sample)
                ...
                next_greedy_actions = next_greedy_actions.expand(batch_size, self.n_p_sample, 1)
